...
export default function CreateAtelierVML2Page() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    router.push('/dashboard/atelier-vml-2');
  };
    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          Créer Nouvelle Entrée - Atelier VML 2
        </h1>
        <p className="text-gray-600">
          Saisie des données de production pour l'Atelier VML 2 (Zone B)
        </p>
      </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="border-t pt-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Suivi de récupération</h3>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Déchireuse: A/VMI1/VMI2/Farhat Hached</FormLabel>
                    <FormControl>
                      <Input placeholder="Sélectionnez la déchireuse" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push('/dashboard/atelier-vml-2')}
              >
                Annuler
              </Button>
            </div>
