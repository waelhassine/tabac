...
export default function CreateAtelierVML1Page() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    router.push('/dashboard/atelier-vml-1');
  };
    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          Créer Nouvelle Entrée - Atelier VML 1
        </h1>
        <p className="text-gray-600">
          Saisie des données de production pour l'Atelier VML 1 (Zone B)
        </p>
      </div>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push('/dashboard/atelier-vml-1')}
              >
                Annuler
              </Button>
            </div>
