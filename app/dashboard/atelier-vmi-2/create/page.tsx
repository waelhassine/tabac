...
export default function CreateAtelierVMI2Page() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    router.push('/dashboard/atelier-vmi-2');
  };
    ...
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900 mb-2">
          Créer Nouvelle Entrée - Atelier VMI 2
        </h1>
        <p className="text-gray-600">
          Saisie des données de production pour l'Atelier VMI 2
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border p-6">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            {/* Same form structure as VMI 1 but with VMI2 specific labels */}
            <FormField
            ...
            <div className="border-t pt-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Déchireuse (VMI2)</FormLabel>
                    <FormControl>
            ...
            <div className="flex gap-4 pt-6">
              ...
              <Button
                type="button"
                variant="outline"
                onClick={() => router.push('/dashboard/atelier-vmi-2')}
              >
                Annuler
              </Button>
            </div>
